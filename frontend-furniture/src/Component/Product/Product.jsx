          ...
          <ul className="product-list glide__slides">
            <li className="product-item glide__slide">
              <div className="product-image">
                <a href="#">
                  <img src="https://e-commerce-udemy.netlify.app/img/products/product2/2.png" alt="" className="img1"/>
                  <img src="https://e-commerce-udemy.netlify.app/img/products/product2/2.png" alt="" className="img2"/>
                </a>
              </div>
